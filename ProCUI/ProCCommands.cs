...
namespace ProCUI
{
    ...
    public class ProCCommands
    {
        ...
        private DocumentCommands _DepartmentCommands = new DocumentCommands();
        /// <summary>
        /// Gets the Department related commands.
        /// </summary>
        public DocumentCommands DepartmentCommands
        {
            get { return _DepartmentCommands; }
            set { _DepartmentCommands = value; }
        }
